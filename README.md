...
基于段建业/郝金阳盲派理论的八字命理推演引擎。58 模块四层架构，860 验证用例全绿。
...
| **Objective** | 客观层 | 26 | 排盘、节气、藏干、长生、十神、空亡、冲合刑害穿破检测、做功识别、墓库、神煞、大运流年、应期、身体部位 |
| **Subjective** | 主观层 | 30 | 层功量化、象法九原则、财命官命、婚姻学历牢狱、职业取象、应期推断、岁运反局、方向判断、六亲、灾祸、诀法、串宫压运 |
