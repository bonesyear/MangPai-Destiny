...
echo "=== famous 23 regression (vs baseline) ==="
python3 mangpai/tests/backtest/regression_famous.py 2>&1 | grep -E "zuogong|gongliang|guanming|caiming|zhiye|hunyin|laoyu|TOTAL|REGRESSION|IMPROVE|无变化"
