...
GUAN = [
    ...
    # 印制伤食市长：书明文「四柱无官，印主权力，所以此造是个官员…升任市长」——
    # 旧 expect False 系 G7 误挡印制伤食+印类无官杀门槛的引擎 bug 编码
    # （K3-294官命批 A4/A5 修复后按书锚改 True，同 test_guanming_g.py）
    ('印制伤食',   ['乙','丁','甲','丙'], ['未','亥','午','子'], True, '⚠️'),
