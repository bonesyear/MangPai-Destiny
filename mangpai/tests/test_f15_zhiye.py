...
1. 军警 8.2 明文组合（批7 P0-3：书明列组合全未实现，军警书例 4 中 1；批8：
   ...
   :11745）；贵气门（:11964「先观格局有无贵气」=官杀主气≥2 柱且透干——
...
def test_shangren_li12_merchant():
    """商人例十二（甲辰丙寅乙酉戊寅，gaoji:11053 开家具厂）——merchant 收窄
...
def test_junguan_li4_blocked_by_guiqi_gate():
    ...
    亦无羊刃，贵气门挡 8.2 组合（gaoji:11964「先观格局有无贵气」）——戌武库
...
def test_guiqi_gate_blocks_no_guan_chart():
    """贵气门（gaoji:11964）：局无官杀主气/羊刃/官杀库者，8.2 字级组合不计
