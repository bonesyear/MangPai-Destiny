...
# 不变（v6 运锚例外照旧）。
# v8（K3 294职业批1·B-a）：_ZY_EXCLUDE['military'] 增「冠军」——体育冠军
# 之「军」为 substring 误命中（cj-运动员「网球冠军」/cj-武术「武术全国
# 冠军」，段氏：体育冠军=比劫做功，同 v4 删「武/兵」之理），2 例转
# unscorable（trainset 职业 n 87→85）；两例 verdict 无其他桶关键词，
# 22✅ 零依赖被排除语境。
RUBRIC_VERSION = 'v8-20260808'
