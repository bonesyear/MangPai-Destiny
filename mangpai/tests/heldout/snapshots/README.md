...
| `20260918_p1.json` | P1 官命检测簇批（A8 支杀化印新 type+A19 食合官支 G9 扩展+A11 贼捕制印新消费边 zeishen→guanming）（**当前基线**） | 见 _meta | l1 | heldout 三维零翻转零抖动；trainset 官 +4（96→100✅）全预注册、财/职零翻转；文本抖动 1 条（zj-平常八字 veto_reasons，A8 门槛机制设计内） |
