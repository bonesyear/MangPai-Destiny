...
AONAXIXI   = (['乙', '己', '己', '庚'], ['巳', '丑', '未', '午'], 4)   # 制例一 奥纳西斯「制库两层功，杀库作功一层功，加包制一层功，有四层功量」（理象学 6470-6474）
YANXISHAN  = (['癸', '辛', '乙', '丁'], ['未', '酉', '酉', '丑'], 3)   # 阎锡山「功量有三层强一点」（理象学 7182-7188 纯制局读法；授课38期「旺忌神弱制」非从杀）
# 普通四柱例
