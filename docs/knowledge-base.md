...
- 残留❌9（heldout）/10（trainset——D1 数据批 gold 修正后实测；修批C 记 11，旧记 8/22 系批4 收官口径，R4）主簇：~~A13 制库基阶~~（**P3 已清⚠️侧 2 例**=富火运/制例二；装璜 gongliang L4 侧收档留后续）/~~A4 伤官见官（土金伤官条款）~~（**P3 收档**=N1 成势怕见官 severe 已承担传导，scored 残余=零，过河拆桥富锚反向锚）/G5 破从残/A1 反局残/~~A12 体坏未入凶向链~~（**P3 收档**=N5 已接入 mingju_xiong，独眼乞食 ✅）。❌10 逐例处置=P3 预注册 §四（zhenbao-14a calib 常驻/cj-种地/yx-破财那几年/yx-建筑/cj-包工头 备案原位；cj-妓女/cj-教授待研；yx-贫家境贫寒一贫 阳日见阴官族/yx-贫穷命贫困线上 身弱财旺+财不做功族 入 backlog P3 收档候选）。
