...
mangpai/
  ...
  tests/
    ...
    calib_assertions.py/.yaml  test_*.py(1059 测,含 test_feishu 34/test_d6b_zinv 12/test_llm_channel 27/test_qianyi 11/test_xiangmao 7/test_key_contract 6/test_inject_faults 79/test_hfix5_* 108)
...
| `python3 -m pytest mangpai/tests/ -q` | 1060 collected（**1059 passed+1 xfailed，H-fix-8 实测**；旧记 842/822(N2b+N3)、794、776、682、499、473 均作废；19 xp 死测试 H-fix-4a 随 chuangong 删除） |
...
python3 -m pytest mangpai/tests/ -q               # 1060 collected（1059 passed+1 xfailed）
