...
> 最后更新：2026-08-17（F2 数据表层批：anhe 删子巳+TOMB_MAP 加戌=土墓+muku 三 P0+传导两守卫，见 §4.9/§4.11；引擎基线 = `snapshots/20260817_f2.json`，heldout 六维 Δ=0）。早前：F0 知识库勘误批（十批审计 46 条勘误+批1-4 散见 8 条落盘，见 §10）。
