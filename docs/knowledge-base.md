...
- **验证口径**：`verify_mangpai.py` 432 项 + `pytest mangpai/tests/` 747 collected（727 passed+1 xfailed+19 xpassed，D5 实测；D4 记 727 同口径；修批B/C 记 682、修批A 记 677、F19 记 668/648、F18 记 664、F17 记 646、F15 记 606、F13 记 585、F12 记 576、F11 记 543、F10 记 536、F9 记 532、F7 记 517、F6 记 529、批10 旧记 499 均作废）+ blind_eval 快照零翻转 + 双 seed 逐字节一致（旧 853 口径 2026-07-17 起作废）。
...
| `python3 -m pytest mangpai/tests/ -q` | 747 测（D5 实测：727 passed+1 xfailed+19 xpassed；修批B/C 记 682、F19 记 668/648、批10 记 499、旧记 473 均作废） |
...
python3 -m pytest mangpai/tests/ -q               # 747 collected（727 passed+1 xfailed+19 xpassed）
...
| 42 | （外部归档） | selectors「35 键」 | 记录：实际 39 键；compute_all 输出 49 键（KB 未载旧值，备查）。**修批A③（2026-08-18）起 38 键——gongmen_wuzhi 摘除（is_wuzhi 98.8% 恒真零信息量，payload 通道切断），engine result 键保留** | 批10勘误2 |
