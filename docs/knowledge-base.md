...
- **验证口径**：`verify_mangpai.py` 432 项 + `pytest mangpai/tests/` 524 collected（504 passed+1 xfailed+19 xpassed，F4 实测；批10 旧记 499、更旧 473 均作废——F2/F3/F4 哨兵各 +11/+8/+6）+ blind_eval 快照零翻转 + 双 seed 逐字节一致（旧 853 口径 2026-07-17 起作废）。
