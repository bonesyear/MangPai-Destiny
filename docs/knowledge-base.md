...
- **验证口径**：`verify_mangpai.py` 432 项 + `pytest mangpai/tests/` 576 collected（556 passed+1 xfailed+19 xpassed，F12 实测；F11 记 543、F10 记 536、F9 记 532、F7 记 517、F6 记 529、批10 旧记 499 均作废——F2/F3/F4/F6/F7/F9/F10/F11/F12 哨兵各 +11/+8/+6/+2/+8/+10/+4/+7/+13）+ blind_eval 快照零翻转 + 双 seed 逐字节一致（旧 853 口径 2026-07-17 起作废）。
