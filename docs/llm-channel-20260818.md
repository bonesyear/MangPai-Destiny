...
### 四指标达标线（终态 = remap 离线重评分，n=281 含 reading 例）

| 指标 | 达标线 | 实测 | 判定 |
|---|---|---|---|
| L0 schema 违规率 | ≈0 | 1/281 = **0.36%** | ✅ |
| L1 basis 无出处率 | <5% | 0/281 = **0.00%**（remap 转正 10 条，违规 0） | ✅ |
| N1 数字违规率 | <2% | 1/281 = **0.36%** | ✅ |
| L2 枚举回对违规率 | 参考（无硬线） | 14/281 = **4.98%**（财档越限 11 + 官命矛盾 3） | 参考 |
